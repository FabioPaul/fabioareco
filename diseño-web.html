...
<body>
    <div id="all">
        ...
        <div>
            ...
            <div class="portfolio-header"> <span class="color"> Mi </span> Portfolio<span class ="header-caption"> Some Of My <span class="color"> Works</span></span></div>
            <div id="portfolio-content">
            <!--section>
                 <div class="col-md-12 portfolio portfolio-first">
                     ...
                     <div class="col-md-6 portfolio-text">
                         <h2>Diseño Web</h2>
                         <p class="text-white">Aquí se encuentran todas las Páginas Web con las que trabaje.</p>
                         <div class="button"><a href="#"><button><span class="index">Ver Proyectos<i class="gg-arrow-right"></i></span></button></a></div>
                     </div>
                 </div>
                 ...
                 <div class="portfolio portfolio-second">
                    ...
                    <div class="portfolio-text">
                        ...
                        <p>Aquí se encuentran todas los Diseños y Videos con los que trabaje.</p>
                        <div class="button"><a href="#"><button><span class="index"> Ver Proyectos<i class="gg-arrow-right"></i></span></button></a></div>
                    </div>
                </div>
                ...
                <div class="portfolio portfolio-third">
                    ...
                    <div class="portfolio-text">
                        <h2>Ilustraciones</h2>
                        <p>Aquí se encuentra todas las Ilustraciones con las que trabaje.</p>
                        <div class="button"><a href="#"><button><span class="index"> Ver Proyectos<i class="gg-arrow-right"></i></span></button></a></div>
                    </div>
                </div>
            </section-->
            <div class="services-content">
                            <a href="">
                                <div class="service-one service wow">
                                   ...
                                   <div class="service-description">
                                    <h2>Diseño Web</h2>
                                    <p>Principalmente páginas web estaticas.</p>
                                   </div>
                               </div>
                           </a>
                           <div class="service-two service wow">
                            <a href="">
                               ...
                               <div class="service-description">
                                <h2>Social Media</h2>
                                <p>Tareas como Community Manager.</p>
                               </div>
                                </a>
                           </div>
                           <div class="service-three service wow">
                            ...
                            <div class="service-description">
                                <h2>Diseño Gráfico</h2>
                                <p>Principalmente generación de marca gráfica.</p>
                            </div>
                            </a>
                        </div>
                    </div>
